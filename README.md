...
As a result, it was encouraged to make helper scripts that would call the vega CLI and provide a friendlier UX.
...
> They are in the [scripts](./scripts) subdirectory.
